...
// Official Spotify Logo (SVG path from their guidelines)
...
export default function SpotifyConnectButton({ 
  ...
  const handleConnect = () => {
    setLoading(true);
    // Redirect to the login route which handles the OAuth dance
    window.location.href = "/api/guest/spotify/login";
  };
